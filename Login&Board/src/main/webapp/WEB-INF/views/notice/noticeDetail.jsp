		...
		<div class="table-area">
			<table align="center">
				...
				<tr>
					<td>내용 </td>
					<td colspan="3">
						<textarea style="resize:none; width:90%; height:200px;" style="resize:none;" readonly><c:out value="${ requestScope.notice.body }"/></textarea>
					</td>
				</tr>
			</table>
			<br>
			<div align="center">
				...
				<c:if test="${ sessionScope.loginMember.role eq 'ROLE_ADMIN' }">
					<button class="btn btn-or" onclick="location.href='${ pageContext.servletContext.contextPath }/notice/update?no=${ requestScope.notice.no }'">수정하기</button>
					<button class="btn btn-bs" onclick="location.href='${ pageContext.servletContext.contextPath }/notice/delete?no=${ requestScope.notice.no }'">삭제하기</button>
				</c:if>
			</div>
		</div>
	</div>
